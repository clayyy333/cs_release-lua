...
local esToEn = {
    ...
    ["No hay canciones favoritas."] = "There are no liked songs.",
    ["Eliminar de favoritos"] = "Remove from liked songs",
    ["No hay resultados."] = "There are no results.",
    ["No se pudo consultar el buscador."] = "The search provider could not be reached.",
    ["El buscador yt-dlp no esta instalado en el backend."] = "The yt-dlp search provider is not installed on the backend.",
    ["El buscador no pudo conectarse a YouTube."] = "The search provider could not connect to YouTube.",
    ["La clave de YouTube API no esta configurada en el backend."] = "The YouTube API key is not configured on the backend.",
    ["La API oficial de YouTube no pudo responder."] = "The official YouTube API could not respond.",
    ["YouTube bloqueó la descarga automática."] = "YouTube blocked the automated download.",
    ["No se pudo procesar la descarga."] = "The download could not be processed.",
    ["La descarga no tiene una URL válida."] = "The download does not have a valid URL.",
    ["El conversor de audio no está disponible."] = "The audio converter is not available.",
    ["La descarga falló."] = "The download failed.",
    ...
    ["Añadir a la fila de reproduccion"] = "Add to queue",
    ["Guardar en tus canciones favoritas"] = "Save to liked songs",
    ["Eliminar archivo"] = "Delete file",
    ["Estas seguro de eliminar este archivo?"] = "Are you sure you want to delete this file?",
    ["Eliminar"] = "Delete",
    ["Listas"] = "Playlists",
    ["Lista"] = "Playlist",
    ...
    ["Eliminar Playlist"] = "Delete Playlist",
    ["Eliminar de Playlist"] = "Remove from Playlist",
    ["Estas seguro de eliminar esta playlist?"] = "Are you sure you want to delete this playlist?",
    ["Esta playlist esta vacia."] = "This playlist is empty.",
    ["No hay playlists."] = "There are no playlists.",
    ["Busca musica o pega link para ver resultados"] = "Search music or paste a link to view results",
    ["RESULTADOS DE BUSQUEDA :"] = "SEARCH RESULTS :",
    ["MAS ESCUCHADAS EN STRIKE MUSIC:"] = "MOST PLAYED ON STRIKE MUSIC:",
    ["Ver todo"] = "See all",
    ["Reproduciendo ahora"] = "Now Playing",
    ["Siguiente"] = "Up Next",
    ["Limpiar"] = "Clear",
    ["Nombre de musica"] = "Music name",
    ["Artista"] = "Artist",
    ["Sin titulo"] = "Untitled",
    ["Desconocido"] = "Unknown",
    ["Nada reproduciendose"] = "Nothing playing",
    ["Selecciona una cancion"] = "Select a song",
    ["La cola esta vacia."] = "The queue is empty.",
